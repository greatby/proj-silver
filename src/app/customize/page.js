...
export default function CustomizePage() {
  const jsonLd = {
    ...
    description:
      "Upload your logo or text and create personalized 999 silver coins.",
  };
  ...
  return (
    <>
      ...
      {/* HERO */}
      <section className="bg-linear-to-br from-white to-slate-50 py-24 border-b border-slate-100">
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-lg text-slate-600 max-w-xl">
              Personalize your coin with names, dates, blessings, logos or
              custom artwork. Crafted on 999 purity silver with premium
      ...
      <section id="start-customizing" className="py-24 bg-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="mt-4 text-slate-600 max-w-2xl mx-auto">
            Our 4-step customization journey is designed to give you a flawless
        ...
        <div className="container mx-auto px-6 mt-16 grid md:grid-cols-4 gap-12">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-slate-600 mt-2">
              Pick your preferred design, weight and finish from our premium
              collection.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-slate-600 mt-2">
              Your custom 999 silver coin is engraved, certified & delivered in
              3-7 days.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl font-bold text-slate-900">
              Why Choose Custom Silver Coins?
            </h2>
            <p className="mt-6 text-slate-600 text-sm leading-relaxed max-w-xl">
              Personalized silver coins add unmatched elegance to any
              celebration. Whether it's a wedding, baby shower, housewarming,
              pooja or corporate event, your message or brand engraved in 999
              purity silver makes a lasting impact.
            </p>
          </div>
      ...
      <section className="py-20 text-center bg-linear-to-br from-white to-slate-50 border-t border-slate-100">
        ...
        <p className="mt-4 text-slate-600 text-sm max-w-lg mx-auto">
          Start your customization journey and make your silver coin
          unforgettable.
        </p>
